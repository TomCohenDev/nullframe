...
**Injector Points** are currency for narrative control. You earn them by accepting complications. You spend them to inject facts, assets, and twists into the story.

The GM has IPs too. The economy flows both ways.

### Narrative Injection

This is the game's core hook. At any moment, you can spend IPs to **inject** something into the scene:

- "There's a fire escape on this building."
- "This guard served in my old unit."
- "I brought a grappling hook, actually."
...
- **Sci-Fi:** Starships, alien contact, space horror
- **Modern:** Spies, heists, supernatural investigation
- **Post-Apocalypse:** Survival, scavenging, community building

The GM section includes guidance for adapting the game to different genres.
...
See the Table of Contents for a complete chapter listing.
...
If you're the GM, read everything.
