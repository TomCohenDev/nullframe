...
- **The Horror of the Absent God** — There is no Fourth God. There is nothing in the universe that cares. The Cult invented a god and that act of invention killed everyone.
- **Consequence Without Villain** — No living perpetrator remains. No enemy to overthrow. No justice to extract. Only the long, slow, inhuman aftermath.
- **Survival as Moral Pressure** — Every decision costs something. Resources are finite. People will die. Named NPCs die when the math says they should.
- **The Marsh as Antagonist** — The planet itself is the threat. The wetland and its anomalies grind colonists down without intent or malice.
- **Hope as Rope** — The promise of rebuilding the Korenfeld Drive keeps colonists from despair. It is also probably impossible.
- **The Horror of Discovery** — The truth is buried in ruins, cult writings, broken technology, and garbled mythology. Knowing why everything died does not bring anything back.
...
- political tension between colony factions
- the question of whether to stay, rebuild, or find a way off-world
...
- technicians
- community leaders
- specialists of a world that died while they slept
...
- anomalous terrain surrounding the crash site
- first contact with marsh-dwellers
- the mysterious surface broadcast
- political fractures inside the colony
- grief, denial, and psychological collapse
- equipment degradation and salvage needs
...
- **Entities** — Discrete creatures or things arising from anomalous matter. May have once been animals, people, or plants. No longer classifiable.
- **Zones** — Geographic regions where matter does not behave correctly. Water isn't water. Gravity shifts. Time feels wrong. Light bends.
- **Phenomena** — Effects, weather, ambient wrongness. Fog that carries change. Rain that dissolves. Sound that echoes from the wrong direction.
...
- How granular should anomaly exposure tracking be?
- Should there be a formal "exposure clock" or is narrative tracking enough?
- What happens when a colonist is heavily exposed but survives? Do they gain anything, or only lose?
- How do the marsh-dwellers perceive anomaly exposure versus the colonists?
...
- shelter and power degradation
- wounded and sick colonists
- psychological collapse and morale failure
- leadership disputes and faction conflict
- equipment failure and supply shortages
- the question of what to do (stay, rebuild, leave)

## Marsh Pressures

- anomalous terrain and unstable ground
- undrinkable water
- unclassifiable wildlife
- fog and weather that carries wrongness
- no long sightlines
- sound carrying strangely
- bodies that sink and resurface elsewhere
- the marsh changing between visits

## Discovery Pressures

- ruins from old Rimaer-Prime civilization
- cult writings and religious artifacts
- broken Korenfeld technology
- the truth of what happened to the world
- the mystery of the surface broadcast
- the psychological weight of learning the truth

## Social Pressures

- colony factions vying for control
- marsh-dweller first contact
- trust between strangers sharing a crashed ship
- triage decisions — who gets resources, who doesn't
- the question of children, families, and the future
- colonists breaking under the weight of displacement
...
RimWorld-style colony management is central to the Rimaer experience. The framework should reinforce that the colony is a shared system the players are responsible for.

### Colony Resource Categories

These categories should be tracked at a high narrative level:

- **Food** — stored rations, cultivated crops, foraged supplies
- **Water** — purified reserves, treatment capacity, source quality
- **Power** — Oasis reactor output, backup generators, fuel reserves
- **Shelter** — habitable space, structural integrity, expansion capacity
- **Medical** — supplies, treatment capacity, quarantine space
- **Materiel** — tools, weapons, raw materials, fabrication stock
- **Morale** — psychological state of the colony as a whole
...
- the Storyteller tracks colony state and introduces pressure based on it
- players should feel the weight of allocation decisions without drowning in bookkeeping

### Open Questions

- How abstract should resource tracking be?
- Should colony management happen between sessions, during play, or both?
- What role do NPCs play in colony operations?
- Should there be "colony actions" between sessions (RimWorld-style time passage)?
...
The Korenfeld Drive is the central long-term hook. Rebuilding it is the colony's hope of escape — and probably impossible.

Key points for the framework:

- the drive accesses the Korenfeld Medium (the Relational Substrate Field) — a fourth-dimensional informational layer of reality
- it rewrites atomic properties, including spatial position — it is a reality editor
- powering it requires stellar-scale energy (the Dyson sphere is gone)
- unprotected minds cannot survive fourth-dimensional exposure
- the drive's true capability (rewriting any atomic property) is what made it a weapon
- the cult believed the Medium contained a god; it does not

### Drive Reconstruction as Campaign Arc

- discovering the drive's nature and history is a major investigation thread
- rebuilding it requires exotic materials, energy sources, and knowledge
- the moral question: should they rebuild the thing that destroyed the world?
- multiple campaign endings possible depending on what players do with a working drive (if they ever get one)
...
Colony gear should feel like a mix of advanced technology degrading in a hostile environment and improvised solutions built from salvage.

Likely categories:

- Oasis stores (rationed, tracked, finite)
- salvaged pre-collapse technology (found in ruins, condition unknown)
...
Threats should come from the marsh, from within the colony, and from the discovery of what happened.

### Suggested Categories

- anomalous entities (marsh creatures, former animals, unclassifiable things)
- environmental hazards (anomalous zones, weather, unstable terrain)
- marsh-dweller encounters (not always hostile — often complicated)
- colony internal threats (psychological collapse, faction violence, sabotage)
- pre-collapse remnants (automated systems, cult artifacts, damaged Korenfeld technology)
...
- Possible remnant cult descendants
- Unknown origin of the surface broadcast
...
- Oasis-centered survival campaigns
- short arcs about triage, scarcity, and hard colony decisions
- first expeditions into the marsh
- first contact with marsh-dwellers
- investigation of ruins and pre-collapse sites
- gradual discovery of the Cult, the Drive, and what happened
...
Setting inspired by RimWorld — colony survival, colonist skills, triage decisions, resource management, mental breaks.

All lore lives in `/Users/tomcohen/github/ttrpg_stories/rimaer/` organized by category (Lore, Campaign, Colony, Characters, Factions, Locations, Anomalies, Tech & Items).
...
- What is the right balance between colony management scenes and field expedition scenes?
- How early should the Cult of the Fourth surface in play?
- Should the Broadcast be resolved in Act 1 or held as a longer mystery?
- What role do time-skip mechanics play between sessions? (RimWorld's day-to-day passage)
- How much of the Korenfeld Drive's true nature should be discoverable in early play?
