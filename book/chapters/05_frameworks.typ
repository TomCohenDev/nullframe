...
#columns(2, gutter: 4mm)[
  ...
  *Rimaer-Prime* was human civilization at its apex. Sixty-two billion people. One government — the *Pantheon* — spanning a single temperate world and three terraformed moons. Disease eliminated. Lifespans extended. Cybernetics common. A Dyson sphere under construction around the sun. And at the center of it all: the *Korenfeld Drive* — humanity's first faster-than-light engine, proven and ready for its first true test.
  ...
  The Oasis's records show only this: the main drive failed partway through its rewrite process. The smaller backup drive engaged automatically and spent approximately *400 years* completing an emergency trace-back. When your pod opened, you were in orbit above Rimaer-Prime — the world you had left. The instruments confirmed the date. Four centuries had passed. Six hundred of your fellow colonists never woke up.

  #v(1mm)

  The communications array found no Pantheon transmissions. No civilian broadcasts. No emergency signals on any frequency the Oasis was built to receive.
  ...
  The orbit was decaying. Life support was burning through reserves. The colonists had weeks before the ship re-entered atmosphere on its own. They had to land.

  #v(1mm)

  The Oasis came down in a marshland at the edge of what was once a coastal metropolitan region. The ship is crashed. Most of it is intact. Enough of it isn't.
